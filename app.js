...
class CatalogApp {
    ...
    generateCatalogPDF() {
        // Forza un ritorno temporaneo alla vista Home complessiva per avere tutti i brand ordinati correttamente
        this.currentView = { type: 'home', value: null };
        this.render();
    ...
    sendCatalogWhatsApp() {
        ...
        const numeroTelefono = currentAdmin.telefono.replace(/\s+/g, ''); // Rimuove spazi vuoti
